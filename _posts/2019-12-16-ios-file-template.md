...
* TemplateIcon.png
* TemplateInfo.plist
* 최종적으로 생성되는 \_\_\_FILEBASENAME\_\_\_.swift
...
* 탬플릿 폴더 생성 : 아래 __규약대로 폴더를 만들어야 정상적으로 template이 생성됩니다!__
	1. {TemplateName}Swift
	2. {TemplateName}XIBSwift
* TemplateInfo.plist에서 options에 XIB checkbox option 추가
